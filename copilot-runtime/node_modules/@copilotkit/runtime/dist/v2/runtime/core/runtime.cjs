...
var BaseCopilotRuntime = class {
	constructor(options, runner) {
		...
		if (this.resolvedLicenseToken) require_telemetry_client.default.setLicenseToken(this.resolvedLicenseToken);
...
exports.isA2UIEnabled = isA2UIEnabled;
