...
import { BaseEvent, Interrupt, RunAgentInput } from "@ag-ui/client";
 ...
 */
declare function convertTanStackStream(stream: AsyncIterable<unknown>, abortSignal: AbortSignal, pendingInterrupts?: Interrupt[]): AsyncGenerator<BaseEvent>;
//#endregion
